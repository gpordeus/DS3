...
int Smart_RemovingAndReorderingEntitiesInAQueue::main(int argc, char** argv) {
	...
	processingOnMachine->setDelayExpression("unif(7,10)");
        processingOnMachine->setDelayTimeUnit(Util::TimeUnit::minute);
	...
	secondaryProcess->setDelayExpression("unif(6,9)");
        secondaryProcess->setDelayTimeUnit(Util::TimeUnit::hour);
	...
	createControlEntity->setTimeBetweenCreationsExpression("1", Util::TimeUnit::minute);
        Assign* assign1 = plugins->newInstance<Assign>(model, "assign1");
